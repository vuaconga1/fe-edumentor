...
import { HiTrash, HiEyeOff, HiRefresh, HiEye, HiChevronDown, HiChevronUp, HiX } from "react-icons/hi";
...
export default function PostsPage() {
    ...
    return (
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
            {/* Header */}
            <div>
                <h1 className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white">Posts</h1>
            ...
            <div className="p-3 sm:p-4 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
                ...
                {showFilters && (
                    <div className="lg:hidden mt-3 pt-3 border-t border-neutral-200 dark:border-neutral-700 space-y-3">
                        ...
                        {hasActiveFilters && (
                            <button
                                onClick={() => { setKeyword(""); setFilterStatus("all"); setShowFilters(false); }}
